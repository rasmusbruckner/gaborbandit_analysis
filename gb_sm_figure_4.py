...
df_bic4 = pd.read_pickle('gb_data/df_bic_4.pkl')
df_bic5 = pd.read_pickle('gb_data/df_bic_5.pkl')
df_bic6 = pd.read_pickle('gb_data/df_bic_6.pkl')
...
# Parameter recovery
# These data were generated using the script gb_recovery.py
param_recov_sigma = pd.read_pickle('gb_data/param_recov_sigma.pkl')
param_recov_1 = pd.read_pickle('gb_data/param_recov_1.pkl')
param_recov_2 = pd.read_pickle('gb_data/param_recov_2.pkl')
param_recov_3 = pd.read_pickle('gb_data/param_recov_3.pkl')
param_recov_4 = pd.read_pickle('gb_data/param_recov_4.pkl')
param_recov_5 = pd.read_pickle('gb_data/param_recov_5.pkl')
param_recov_6 = pd.read_pickle('gb_data/param_recov_6.pkl')
...
# Save plot
savename = 'gb_figures/gb_sm_figure_4.pdf'

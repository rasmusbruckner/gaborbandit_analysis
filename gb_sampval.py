...
# todo: im ersten teil wird o_t nicht gesampled, im zweiten schon!
# todo: vielleicht integral nehmen? kommentar in supplement stecken!
    ...
    for t in range(0, T):
        ...
        for r in range(0, len(p_hat.r_e)):
            ...
            for i in range(0, len(p_hat.o)):
                ...
                agent.o_t = p_hat.o[i]  # observation

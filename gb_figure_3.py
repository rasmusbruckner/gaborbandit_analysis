...
# Parameter estimates
part_params = pd.read_pickle('gb_data/modelbased.pkl')  # these data were generated using the script gb_estimation.py
...
trial_wise_part = pd.read_pickle('gb_data/trial_wise_part.pkl')  # these data were generated using gb_figure_1.py

# Model performance
f = open('gb_data/postpred.pkl', 'rb')  # these data were generated using gb_postpred.py
...
ax_2.legend([part, A0, A1, A2, A3, A4, A5, A6],
            ['Behavioral Data', 'A0 | Random Choice', 'A1 | Belief-state Bayesian',
             'A2 | Categorical Bayesian', 'A3 | A1/A2 Bayesian mixture',
             'A4 | Belief-state Q-learning', 'A5 | Categorical Q-learning',
             'A6 | A4/A5 Q-learning mixture'], handler_map={tuple: HandlerTuple(ndivide=None)},
...
f.text(0.95, 0.27, 'Belief state', size=5, rotation=0, color='k', ha="center", va="center")
f.text(0.49, 0.15, 'Categorical', size=5, rotation=0, color='k', ha="center", va="center")
